...
<body  style="background: #232427" data-spy="scroll" data-target=".navbar" data-offset="50">
  ...
  <div class="main">
    <div class="mainbg">
     ...
     <!-- Sign up Pop-up -->
     <div class="modal" id="fmyModal">
      <div class="modal-dialog ">
        <div class="modal-content">
          <!-- Modal Header -->
          <div class="modal-header">
            <h4 class="modal-title"> farmer Sign Up</h4>
      ...
      <section>
        ...
        <!-- Login pop-Up -->
        <div class="modal" id="fmyModal1">
          <div class="modal-dialog">
            <div class="modal-content">
              <!-- Modal Header -->
              <div class="modal-header">
                <h4 class="modal-title">Farmer Sign In</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
              </div>
              <!-- Modal body -->
              <div class="modal-body">
    ...
    $.ajax({
      ...
      success:function(data){
        ...
        if(data==2){
          ...
          setTimeout(function(){
            window.location.replace("farmerIndex.php");
          },1200);
        }
        if(data==3){
